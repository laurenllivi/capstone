...
urlpatterns = [
    ...
    url(r'^answer_security_questions/$', views.answer_security_questions, name='answer_security_questions'),
    ...
    url(r'^username_email_confirmation/$', views.username_email_confirmation, name='username_email_confirmation'),
